...
const UIHandler = (() => {
    ...
    function renderFileList() {
        const files = JsonManager.getAllFiles();
    ...
    function attachEventListeners() {
        ...
        // 链接复选框联动全选
        function updateLinkSelectState() {
...
window.updateLinkSelectState = updateLinkSelectState;
window.updateRemoveBtnState = updateRemoveBtnState;